...
if os.path.isfile(_env_path):
    try:
        ...
        # Manual fallback: parse .env file
...
@app.get("/feishu")
async def serve_feishu_console():
    """Return Feishu task console page"""
    page_path = os.path.join(WEBUI_DIR, "feishu.html")
    if os.path.exists(page_path):
        return FileResponse(page_path)
    return {"message": "Feishu console not found"}
